...
export async function POST(request: NextRequest) {
  // SECURITY: this route directly approves a waitlist entry by email → workspace-admin only.
  ...
  try {
    ...
    console.log('✅ Approving waitlist request for:', email);
          ...
          <div class="container">
            ...
            <div class="content">
              <div class="welcome-box">
                <h2 style="margin-top: 0; color: #7c3aed;">Hi ${escapeHtml(firstName)}! 👋</h2>
    ...
    return NextResponse.json({ 
      message: 'Request approved and registration email sent',
      registrationLink
    }, { status: 200 });
