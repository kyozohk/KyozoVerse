...
export default function CommunityBroadcastPage() {
  ...
  return (
    <div className="p-6 md:p-8">
       <Card>
        <CardHeader>
          <CardTitle className="text-2xl">Broadcasts</CardTitle>
          <CardDescription>
            {canBroadcast ? `Send announcements to @${handle}` : `Announcements for @${handle}`}
          </CardDescription>
        </CardHeader>
        <CardContent>
          <ListView
          ...
          >
            <div className="text-center col-span-full py-12 text-muted-foreground">
              Broadcast history and creation tools coming soon.
            </div>
          </ListView>
        </CardContent>
      </Card>
