    ...
    <div className="relative w-full overflow-hidden h-20 mb-px p-0">
      ...
      >
        {repeatedItems.map((item, index) => (
          <div 
            key={`item-${index}`} 
            className="flex items-center justify-center gap-1 px-14 py-6 rounded-full font-light text-lg transition-all duration-300 cursor-default bg-accent border-2 border-border text-accent-foreground hover:brightness-95"
          >
